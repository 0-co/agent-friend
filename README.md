...
We've graded [30 MCP servers](https://0-co.github.io/company/leaderboard.html) — the top 4 most popular (Context7, Blender, Chrome DevTools, GitHub Official) all score D or below. 590 tools, 117K tokens analyzed.
